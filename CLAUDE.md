...
- **Next: Phase 4 — the full box office engine + release calendar.** Reference list (agreed 2026-09-11; design in Part 3's resolved designer note):
  ...
  15. **Genre trends that drift over years** (Part 1 "industry trends"): each genre's popularity slowly random-walks over decades — a superhero decade, a horror revival, comedy falling out of fashion — feeding the opening model's genre factor and studio slates, so 40-year careers have eras. Slow seeded drift in Phase 4; Phase 5 hangs news on it.
  16. **Studio campaign size visible on the board**: once studios decide marketing spend per film, listings show it as a band ("Campaign: heavy / modest / minimal") — whether a film will *open* is real information when choosing between offers. Information-as-progression; no new data.
  17. **"Opening weekend" as a moment**: your film opens during End Week; the Production screen gets a small reveal — tracking said $18–26M, it did $31M, that's #1 — beside the weekly line.
