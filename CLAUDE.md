...
- **Next: Phase 4** — the full box office engine (release calendar, seasonality, competition for screens, opening/legs model per Part 1's Box Office Realism) + `ReleaseCalendarEngine`.
